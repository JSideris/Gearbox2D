import"./modulepreload-polyfill-B5Qt9EMX.js";import{M as nn}from"./markdown-tUR2hliS.js";import{g as t}from"./world-BAe1p98x.js";class w{constructor(o){this.onInit=o.onInit,this.onInitRaw=o.onInitRaw,this.onTick=o.onTick,this.onTickRaw=o.onTickRaw,this.onCleanup=o.onCleanup,this.description=o.description,this.name=o.name,this.key=o.key,this.globalLines=o.globalLines||[]}init(o){this.onInit?.(o)}tick(o,n){this.onTick?.(o,n)}cleanup(o){this.onCleanup?.(o)}}let B=1,_e=0,oe=null,Pe=null,E=null;const $e=(e,o)=>({x:(e-t.debug.offsetX)/(t.debug.zoom*100),y:(o-t.debug.offsetY)/(t.debug.zoom*100)});let Lt=0,dt=null,ze=!1;const on=(e,o)=>{if(e.button!==0)return;const n=E.getBoundingClientRect(),a=$e(e.clientX-n.left,e.clientY-n.top);Lt=performance.now(),dt=a,ze=!1,St(a,o)&&(ze=!0)},sn=e=>{const o=E.getBoundingClientRect(),n=$e(e.clientX-o.left,e.clientY-o.top);Xt(n)},an=(e,o)=>{if(e.button!==0)return;const n=performance.now()-Lt;!ze&&n<250&&dt&&_t(dt,o),Ht(o),ze=!1},St=(e,o)=>{const n=o.queryPoint(e.x,e.y);if(n.length>0){const a=n[0],s=o.getObjectById(a);if(s&&s.type!==t.bodyTypes.FIXED_OBJECT)return oe=o.makeObject(999999,{x:e.x,y:e.y,type:t.bodyTypes.FIXED_OBJECT,shape:t.shapes.CIRCLE,radius:.05,color:"transparent",maskBits:0}),Pe=o.createSpringJoint(999998,oe,s,{worldAnchor:e,frequencyHz:3,dampingRatio:1,length:0}),!0}return!1},Xt=e=>{oe&&(oe.x=e.x,oe.y=e.y)},Ht=e=>{Pe&&(e.removeJoint(Pe.id),Pe=null),oe&&(e.removeObject(oe.id),oe=null)},_t=(e,o)=>{const n=["#ff4444","#44ff44","#4444ff","#ffff44","#ff44ff","#44ffff"];for(let a=0;a<3;a++)o.makeObject(B++,{x:e.x+(Math.random()-.5)*.2,y:e.y+(Math.random()-.5)*.2,shape:Math.random()>.5?t.shapes.CIRCLE:t.shapes.BOX,radius:.15,width:.3,height:.3,mass:.5,color:n[Math.floor(Math.random()*n.length)],restitution:.6})};let Ft=0,lt=null,Ye=!1;const rn=(e,o)=>{e.preventDefault();const n=E.getBoundingClientRect(),a=e.touches[0],s=$e(a.clientX-n.left,a.clientY-n.top);Ft=performance.now(),lt=s,Ye=!1,St(s,o)&&(Ye=!0)},cn=e=>{e.preventDefault();const o=E.getBoundingClientRect(),n=e.touches[0],a=$e(n.clientX-o.left,n.clientY-o.top);Xt(a)},dn=(e,o)=>{e.preventDefault();const n=performance.now()-Ft;!Ye&&n<250&&lt&&_t(lt,o),Ht(o),Ye=!1},ln=[new w({name:"Interactive Sandbox",key:"sandbox",description:["Welcome to **Gearbox2D**! This is an interactive playground featuring various shapes and physics properties. Click and drag objects to interact with them.","### Features","- **Point Query**: The engine detects which object is under the mouse using **BVH** and precise shape tests.","- **Mouse Joint**: Uses a `SpringJoint` to pull objects toward the mouse cursor.","- **Collision Filtering**: The mouse 'anchor' object is a sensor that doesn't collide with other objects."].join(`
...
`),onInitRaw:`(world) => {
        ...
        }`,onInit:e=>{e.clear(),t.debug.showAabbs=!1,B=1,e.setGravity(0,9.8),e.setHasRestitution(!0),e.setHasFriction(!0),e.makeObject(B++,{x:5,y:9.5,shape:t.shapes.BOX,width:10,height:1,type:t.bodyTypes.FIXED_OBJECT,color:"#444"}),e.makeObject(B++,{x:.2,y:5,shape:t.shapes.BOX,width:.4,height:10,type:t.bodyTypes.FIXED_OBJECT,color:"#444"}),e.makeObject(B++,{x:9.8,y:5,shape:t.shapes.BOX,width:.4,height:10,type:t.bodyTypes.FIXED_OBJECT,color:"#444"});const o=["#ff4444","#44ff44","#4444ff","#ffff44","#ff44ff","#44ffff"];for(let n=0;n<15;n++){const a=2+Math.random()*6,s=2+Math.random()*5,r=o[n%o.length],c={x:a,y:s,mass:1,color:r,linearDamping:.5,angularDamping:1.5},h=Math.random();h<.45?e.makeObject(B++,{...c,shape:t.shapes.CIRCLE,radius:.3+Math.random()*.4}):h<.9?e.makeObject(B++,{...c,shape:t.shapes.BOX,width:.5+Math.random()*.8,height:.5+Math.random()*.8,r:Math.random()*Math.PI}):e.makeObject(B++,{...c,shape:t.shapes.AABB,width:.5+Math.random()*.8,height:.5+Math.random()*.8})}E=document.getElementById("debug-canvas"),e._mouseDownHandler&&E.removeEventListener("mousedown",e._mouseDownHandler),e._mouseMoveHandler&&window.removeEventListener("mousemove",e._mouseMoveHandler),e._mouseUpHandler&&window.removeEventListener("mouseup",e._mouseUpHandler),e._touchStartHandler&&E.removeEventListener("touchstart",e._touchStartHandler),e._touchMoveHandler&&E.removeEventListener("touchmove",e._touchMoveHandler),e._touchEndHandler&&E.removeEventListener("touchend",e._touchEndHandler),e._mouseDownHandler=n=>on(n,e),e._mouseMoveHandler=n=>sn(n),e._mouseUpHandler=n=>an(n,e),e._touchStartHandler=n=>rn(n,e),e._touchMoveHandler=n=>cn(n),e._touchEndHandler=n=>dn(n,e),E.addEventListener("mousedown",e._mouseDownHandler),window.addEventListener("mousemove",e._mouseMoveHandler),window.addEventListener("mouseup",e._mouseUpHandler),E.addEventListener("touchstart",e._touchStartHandler,{passive:!1}),E.addEventListener("touchmove",e._touchMoveHandler,{passive:!1}),E.addEventListener("touchend",e._touchEndHandler,{passive:!1})},onCleanup:e=>{E&&(E.removeEventListener("mousedown",e._mouseDownHandler),window.removeEventListener("mousemove",e._mouseMoveHandler),window.removeEventListener("mouseup",e._mouseUpHandler),E.removeEventListener("touchstart",e._touchStartHandler),E.removeEventListener("touchmove",e._touchMoveHandler),E.removeEventListener("touchend",e._touchEndHandler),delete e._mouseDownHandler,delete e._mouseMoveHandler,delete e._mouseUpHandler,delete e._touchStartHandler,delete e._touchMoveHandler,delete e._touchEndHandler)},onTickRaw:`(world, dt) => {
...
`),onInitRaw:`(world)=>{
        ...
        }`,onTick:(e,o)=>{const n=e.getObjectById(1),a=e.getObjectById(2);if(n&&a){const s=a.x-n.x,r=a.y-n.y,c=s*s+r*r,h=Math.sqrt(c),u=100/c;n.applyForce(u*s/h,u*r/h),t.debug.clearLabels(),t.debug.addLabel({text:"Orbiting with Forces",x:5,y:1,fontSize:"24px Arial",color:"#bbb",position:"on-top"}),t.debug.addLabel({text:`Force Magnitude: ${u.toFixed(2)}`,x:5,y:1.5,fontSize:"16px Arial",color:"#888",position:"on-top"})}}}),new w({name:"Impulse",key:"impulse",description:["**Impulses** are used to apply an instantaneous change in velocity. Unlike forces, impulses do not depend on the time step.","Impulses are perfect for events like jumping, explosions, or collisions where a sudden change in motion is required."].join(`
...
`),onInitRaw:`(world) => {
        ...
        }`,onTick:(e,o)=>{const n=e.elevator;if(n&&(n.y<3&&(n.vy=1),n.y>8&&(n.vy=-1)),e.objectCount<60&&Math.random()>.9){const r=["#ff4444","#44ff44","#4444ff","#ffff44","#ff44ff","#44ffff"],c=Math.random()>.5,h=3+Math.random()*4;e.makeObject(B++,{x:h,y:.5,shape:c?t.shapes.CIRCLE:t.shapes.BOX,radius:.25,width:.5,height:.5,mass:.5+Math.random()*1,type:t.bodyTypes.RIGID_BODY,color:r[Math.floor(Math.random()*r.length)],restitution:.3})}const a=e.toRemove;if(a&&a.size>0){for(const r of a)e.getObjectById(r)&&e.removeObject(r);a.clear()}let s=[];e.iterateObjects(r=>{(r.y>11||r.y<-5||r.x>11||r.x<-1)&&r.type===t.bodyTypes.RIGID_BODY&&s.push(r.id)});for(const r of s)e.removeObject(r)},onCleanup:e=>{e.onCollisionStart=void 0,delete e.elevator,delete e.recyclerId,delete e.toRemove}})];let b=1,ce=[],ge=null,z=null,Ie=null,Z=null,Y=null,ve=0,ke=0;const hn=[new w({name:"Simple Hinge",key:"simple-hinge",description:["A single `BOX` object attached to a `FIXED_OBJECT` by a **Hinge Joint** constraint.","The hinge allows rotation around a single point while preventing all linear relative motion. In this case, it creates a simple gravity-driven pendulum."].join(`
...
`),onInitRaw:`(world) => {
        ...
        }`,onInit:e=>{b=1,t.debug.showAabbs=!1,ce=[],ge=null,z=null;const o=e.makeObject(b++,{x:5,y:1,shape:t.shapes.CIRCLE,radius:.2,type:t.bodyTypes.FIXED_OBJECT,color:"#ff4444"});z=e.makeObject(b++,{x:5,y:2.5,shape:t.shapes.CIRCLE,radius:.4,mass:.05,color:"#888888"}),ge=e.createHingeJoint(b++,o,z,{worldAnchor:{x:5,y:1}});const n=2,a=8,s=6,r=12,c=(a-n)/r,h=.2,u=e.makeObject(b++,{x:n-c/2,y:s,shape:t.shapes.BOX,width:c,height:.5,type:t.bodyTypes.FIXED_OBJECT,color:"#aaaaaa"}),p=e.makeObject(b++,{x:a+c/2,y:s,shape:t.shapes.BOX,width:c,height:.5,type:t.bodyTypes.FIXED_OBJECT,color:"#aaaaaa"});let i=u;for(let d=0;d<r;d++){const y=e.makeObject(b++,{x:n+d*c+c/2,y:s,shape:t.shapes.BOX,width:c*.9,height:h,mass:.2,color:"#cd853f",categoryBits:4,maskBits:-5}),l=e.createSpringJoint(b++,i,y,{worldAnchor:{x:n+d*c,y:s},frequencyHz:4,dampingRatio:1});ce.push(l),i=y}const m=e.createSpringJoint(b++,i,p,{worldAnchor:{x:a,y:s},frequencyHz:4,dampingRatio:1});ce.push(m),e.setGravity(0,10),t.debug.showForceVectors=!0,z.applyImpulse(.2,0)},onTickRaw:`(world, dt) => {
            // 1. Increase mass
            if (massObject) {
        ...
        }`,onTick:(e,o)=>{if(z&&(z.mass+=o*3,t.debug.removeObjectLabels(z.id),t.debug.addLabel({text:`Mass: ${z.mass.toFixed(2)}kg`,objectId:z.id,position:"above",color:"#fff"})),ge){const n=ge.reactionForce;Math.sqrt(n.x*n.x+n.y*n.y)>150&&(e.removeJoint(ge.id),ge=null)}if(ce.length>0)for(let n=ce.length-1;n>=0;n--){const a=ce[n],s=a.reactionForce;Math.sqrt(s.x*s.x+s.y*s.y)>600&&(e.removeJoint(a.id),ce.splice(n,1))}}}),new w({name:"Gear Train",key:"gear-train",description:["A sequence of gears connected using the `GearJoint` constraint.","Each gear's motion is constrained by the previous one based on a **gear ratio** (calculated here by the relative radii).","A drive gear at the start receives a constant low torque, which is then propagated through the entire train with mechanical advantage."].join(`
...
`),onInitRaw:`(world) => {
        ...
        }`,onInit:e=>{b=1;const o=2,n=5,a=5,s=1.5,r=e.makeObject(b++,{x:5,y:5,shape:t.shapes.AABB,width:6.2,height:.2,type:t.bodyTypes.FIXED_OBJECT,color:"#888",maskBits:0});let c=null;Ie=null;for(let h=0;h<a;h++){const u=h%2===0?1:.5,p=e.makeObject(b++,{x:o+h*s,y:n,shape:t.shapes.CIRCLE,radius:u,mass:u,color:`hsl(${h*60}, 70%, 60%)`}),i=e.createHingeJoint(b++,r,p,{worldAnchor:{x:o+h*s,y:n}});if(h===0)Ie=p;else{const d=((h-1)%2===0?1:.5)/u;e.createGearJoint(b++,c,i,d)}c=i}},onTickRaw:`(world, dt) => {
            if (engineHub) {
...
`),onInitRaw:`(world) => {
        ...
        }`,onInit:e=>{t.debug.showAabbs=!1,b=1;const o=5,n=5,a=4,s=e.makeObject(b++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:.5,type:t.bodyTypes.FIXED_OBJECT,color:"#ff4444"});Z=e.makeObject(b++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:a,mass:100,color:"rgba(255, 255, 255, 0.05)",maskBits:0,angularDamping:.5}),e.createHingeJoint(b++,s,Z,{worldAnchor:{x:o,y:n}});const r=8,c=3.8,h=.8,u=()=>({x:(Math.random()-.5)*.3,y:(Math.random()-.5)*.3});for(let p=0;p<r;p++){const i=p/r*Math.PI*2,m=o+Math.cos(i)*c,d=n+Math.sin(i)*c,y=m-Math.cos(i)*.5,l=d-Math.sin(i)*.5,g=e.makeObject(b++,{x:y,y:l,shape:p%2===0?t.shapes.BOX:t.shapes.CIRCLE,width:.5,height:.5,radius:.25,mass:.5,color:`hsl(${p*360/r}, 70%, 60%)`}),I=Z.worldToLocal({x:m,y:d});e.createDistanceJoint(b++,Z,g,{anchorA:I,anchorB:u(),length:h});const v=y-Math.cos(i)*h,O=l-Math.sin(i)*h,A=e.makeObject(b++,{x:v,y:O,shape:(p+1)%2===0?t.shapes.BOX:t.shapes.CIRCLE,width:.5,height:.5,radius:.25,mass:.5,color:`hsl(${p*360/r}, 70%, 50%)`});e.createDistanceJoint(b++,g,A,{anchorA:u(),anchorB:u(),length:h});const T=v-Math.cos(i)*h,F=O-Math.sin(i)*h,j=e.makeObject(b++,{x:T,y:F,shape:(p+2)%2===0?t.shapes.BOX:t.shapes.CIRCLE,width:.5,height:.5,radius:.25,mass:.5,color:`hsl(${p*360/r}, 70%, 40%)`});e.createDistanceJoint(b++,A,j,{anchorA:u(),anchorB:u(),length:h})}e.setGravity(0,9.81),Z.rs=.2},onTickRaw:`(world, dt) => {
            if (drum) {
...
`),onInitRaw:`(world) => {
            ...
            world.setGravity(0, 9.81);
        }`,onInit:e=>{t.debug.showAabbs=!1,b=1;const o=5,n=3,a=2.5,s=3.5,r=e.makeObject(b++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#666666",maskBits:0});Y=e.makeObject(b++,{x:o,y:n,rs:2.5,shape:t.shapes.CIRCLE,radius:a,type:t.bodyTypes.RIGID_BODY,mass:10,color:"#888888",sFriction:1,kFriction:1,angularDamping:.1}),e.createHingeJoint(b++,r,Y,{worldAnchor:{x:o,y:n}});const c=16,h=[];for(let u=0;u<c;u++){const p=u/c*Math.PI*2,i=o+Math.cos(p)*s,m=n+Math.sin(p)*s,d=e.makeObject(b++,{x:i,y:m,shape:u%2===0?t.shapes.BOX:t.shapes.CIRCLE,width:.6,height:.6,radius:.3,mass:1.5,color:`hsl(${u*360/c}, 70%, 60%)`,sFriction:.999,kFriction:.99});h.push(d)}for(let u=0;u<c;u++){const p=h[u],i=h[(u+1)%c],m=i.x-p.x,d=i.y-p.y,y=Math.sqrt(m*m+d*d);e.createSpringJoint(b++,p,i,{length:y*1.1,frequencyHz:5,dampingRatio:.2})}e.setGravity(0,9.81)},onTickRaw:`(world, dt) => {
            if (rotator) {
...
`),globalLines:["let simulationTime = 0;","let nextId = 1;"],onInitRaw:`(world)=>{
        ...
        }`,onInit:e=>{e.setGravity(0,10),ot=3,Oe=0,e.makeObject(Oe++,{x:5,y:8.5,width:20,height:1,vx:0,vy:0,shape:t.shapes.AABB,type:t.bodyTypes.FIXED_OBJECT,mass:2})},onTickRaw:`(world, dt)=>{
            const nObjects = 10;
            simulationTime += dt*2;
        ...
        }`,onTick:(e,o)=>{ot+=o*2,Math.floor(ot/3)>Oe&&Oe<10&&e.makeObject(Oe++,{x:5,y:0,r:(Math.random()-.5)*.1,width:6,height:.5,vx:0,vy:0,shape:t.shapes.BOX,type:t.bodyTypes.RIGID_BODY,mass:.2,sFriction:10,kFriction:10})}}),new w({name:"Shrink Wrap",key:"shrink-wrap",description:["Objects that are put to **Sleep** have their **AABBs** 'shrink-wrapped' to their exact shape bounds.","This provides a slight performance boost during broad-phase collision detection by reducing false positives in the BVH tree for stationary objects."].join(`
...
`),onInitRaw:`(world)=>{
        ...
        }`,onTick:(e,o)=>{}})];let st=0,kt=1;const gn=[new w({name:"TC-1 (SOLVED)",key:"tc-1",hidden:!0,description:["**Test Case 1**: Verifies stability during box-on-box collisions.","Previously, boxes would exhibit 'jitter' or 'explosive' behavior when colliding at certain angles."].join(`
...
`),globalLines:["let nextId = 1;"],onInitRaw:`(world)=>{
        ...
        }`,onInit:e=>{e.setGravity(0,10),st=0},onTickRaw:`(world, dt)=>{
            impulseTimer++;
        ...
        }`,onTick:(e,o)=>{if(st++,st%60==0){let n=.1+Math.random()*.4,a=.2+n*n*.8;e.makeObject(kt++,{x:0,y:7.5,r:Math.PI/2*Math.random(),rs:(Math.random()-.5)*5,vx:(2+Math.random()*5)*1,vy:-6-Math.random()*1,shape:t.shapes.CIRCLE,type:t.bodyTypes.RIGID_BODY,radius:a,mass:n}),n=.1+Math.random()*.4,a=.2+n*n*.8,e.makeObject(kt++,{x:10,y:7.5,r:Math.PI/2*Math.random(),rs:(Math.random()-.5)*5,vx:(2+Math.random()*5)*-1,vy:-6-Math.random()*1,shape:t.shapes.CIRCLE,type:t.bodyTypes.RIGID_BODY,radius:a,mass:n}),e.objectCount;let s=[];e.iterateObjects(r=>{r.y>10.5&&s.push(r)});for(let r of s)e.removeObject(r.id)}}}),new w({name:"TC-9 (SOLVED)",key:"tc-9",description:["**Test Case 9**: Resting stability.","A small box resting on a larger fixed box to verify that gravity and normal impulses reach equilibrium without constant jitter."].join(`
...
`),onInitRaw:`(world) => {
    ...
    }`,onInit:e=>{e.clear(),t.debug.showAabbs=!1,f=1;const o=5,n=2.5,a=1;e.setGravity(0,a),e.setHasRestitution(!0),e.setHasFriction(!0);const s=1,r=2,c=4,h=8,u=new Date,p=u.getSeconds(),i=u.getMinutes(),m=u.getHours()%12,d={crankRadius:.25,groundDist:1,rockerLength:.8,springFreq:.5,springX:o-1.5},y=document.getElementById("clock-tuner-gui");y&&y.remove();const l=document.createElement("div");l.id="clock-tuner-gui",l.style="position:fixed;top:20px;right:20px;width:280px;background:rgba(0,0,0,0.85);color:#0f0;padding:15px;border-radius:8px;font-family:monospace;z-index:1000;box-shadow:0 4px 15px rgba(0,0,0,0.5);font-size:12px;border:1px solid #333;",document.body.appendChild(l);const g=document.createElement("div");g.style="margin:15px 0;padding:10px;border:1px solid #0f0;text-align:center;font-size:16px;font-weight:bold;",g.textContent="Score: 0",l.appendChild(g);const I=document.createElement("button");I.textContent="Export to Console",I.style="width:100%;padding:8px;background:#0f0;color:#000;border:none;border-radius:4px;cursor:pointer;font-weight:bold;margin-bottom:5px;",I.onclick=()=>console.log("Final Parameters:",JSON.stringify(d,null,4)),l.appendChild(I);const v=document.createElement("button");v.textContent="Start Auto-Optimize",v.style="width:100%;padding:8px;background:#444;color:#fff;border:none;border-radius:4px;cursor:pointer;font-weight:bold;",v.onclick=()=>{const k=e.scoreState;k.isOptimizing=!k.isOptimizing,v.textContent=k.isOptimizing?"Stop Auto-Optimize":"Start Auto-Optimize",v.style.background=k.isOptimizing?"#f00":"#444",k.isOptimizing&&(k.bestScore=-1/0,k.optimizationStage="PREPARE",k.optParamIndex=0,k.optDirection=1,k.epsilon=.05,k.lastImprovementIteration=0,console.log("Starting Auto-Optimization..."))},l.appendChild(v);const O=document.createElement("div");O.style="margin-top:10px;font-size:10px;color:#aaa;",O.textContent="Optimizer: Idle",l.appendChild(O);const A={},T=(k,M,ie,re,tn)=>{const Xe=document.createElement("div");Xe.style.marginBottom="10px";const He=document.createElement("div");He.textContent=`${k}: ${d[M].toFixed(2)}`;const G=document.createElement("input");G.type="range",G.min=ie,G.max=re,G.step=tn,G.value=d[M],G.style.width="100%",G.oninput=()=>{d[M]=parseFloat(G.value),He.textContent=`${k}: ${d[M].toFixed(2)}`,pt()},Xe.appendChild(He),Xe.appendChild(G),l.appendChild(Xe),A[M]={slider:G,labelEl:He,label:k}},F=k=>{const M=A[k];M&&(M.slider.value=d[k],M.labelEl.textContent=`${M.label}: ${d[k].toFixed(2)}`)};T("Crank Radius","crankRadius",.05,.5,.01),T("Ground Distance","groundDist",.5,2,.05),T("Rocker Length","rockerLength",.3,1.5,.05),T("Spring Frequency","springFreq",.1,2,.05),T("Spring X Pos","springX",o-3,o-.5,.1);const j=n+2,X=j-d.groundDist,L=a*Math.pow(9/(2*Math.PI),2),fe=L-d.rockerLength,We=e.makeObject(f++,{x:o,y:j,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#888",categoryBits:s,maskBits:0}),xe=e.makeObject(f++,{x:o,y:X,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#888",categoryBits:s,maskBits:0}),V=e.makeObject(f++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#888",categoryBits:s,maskBits:0}),me=.5;R=e.makeObject(f++,{x:o+Math.sin(me)*L,y:j+Math.cos(me)*L,r:-me,shape:t.shapes.CIRCLE,radius:.4,mass:50,color:"#cd853f",categoryBits:r,maskBits:0}),R.angularDamping=.01,e.createHingeJoint(f++,We,R,{worldAnchor:{x:o,y:j},anchorB:{x:0,y:-L}});const S=e.makeObject(f++,{x:o,y:X,r:0,shape:t.shapes.CIRCLE,radius:.5,mass:.5,color:"#aaa",categoryBits:c,maskBits:0});S.angularDamping=.05;const Ae=e.createHingeJoint(f++,xe,S,{worldAnchor:{x:o,y:X}}),we={x:d.crankRadius,y:0},K={x:0,y:-L+fe},qe=Math.sqrt(Math.pow(S.localToWorld(we).x-R.localToWorld(K).x,2)+Math.pow(S.localToWorld(we).y-R.localToWorld(K).y,2)),ae=e.createDistanceJoint(f++,S,R,{anchorA:we,anchorB:K,length:qe}),Ue=e.makeObject(f++,{x:d.springX,y:X-1,shape:t.shapes.CIRCLE,radius:.05,type:t.bodyTypes.FIXED_OBJECT,color:"#ff4444",categoryBits:s,maskBits:0}),qt=e.createSpringJoint(f++,Ue,S,{anchorB:{x:.5,y:0},frequencyHz:d.springFreq,dampingRatio:.2,length:1.2}),pt=()=>{const k=j-d.groundDist;xe.y=k,S.y=k,Ae.localAnchorA=xe.worldToLocal({x:o,y:k}),ae.localAnchorA={x:d.crankRadius,y:0};const M=L-d.rockerLength;ae.localAnchorB={x:0,y:-L+M};const ie=S.localToWorld(ae.localAnchorA),re=R.localToWorld(ae.localAnchorB);ae.length=Math.sqrt(Math.pow(re.x-ie.x,2)+Math.pow(re.y-ie.y,2)),Ue.x=d.springX,Ue.y=k-1,qt.frequencyHz=d.springFreq};e.scoreState={fastGear:S,pendulum:R,params:d,updateSimulation:pt,updateSliderUI:F,optStatus:O,lastFastR:S.r,history:[],periodTimes:[],lastPendSide:Math.sign(R.r),lastPendCrossing:0,scoreDisplay:g,isOptimizing:!1};const Ut=8/60,Ne=o+1.5,Ve=X+.5,Nt=e.makeObject(f++,{x:Ne,y:Ve,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#888",categoryBits:s,maskBits:0}),mt=e.makeObject(f++,{x:Ne,y:Ve,shape:t.shapes.CIRCLE,radius:1,mass:.2,r:0,color:"#44ff44",categoryBits:c,maskBits:0});mt.angularDamping=.02;const gt=e.createHingeJoint(f++,Nt,mt,{worldAnchor:{x:Ne,y:Ve}});e.createGearJoint(f++,Ae,gt,.25);const Re=p/60*Math.PI*2,ut=e.makeObject(f++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:.6,mass:.2,r:Re,color:"#ff4444",categoryBits:c,maskBits:0});ut.angularDamping=.02;const Ke=e.createHingeJoint(f++,V,ut,{worldAnchor:{x:o,y:n}});e.createGearJoint(f++,gt,Ke,Ut/.25);const Me=i/60*Math.PI*2,je=m/12*Math.PI*2,De=3.5,Le=3,Se=2;for(let k=0;k<12;k++){const M=k/12*Math.PI*2-Math.PI/2,ie=3.8,re=4;e.makeObject(f++,{x:o+Math.cos(M)*(ie+re)/2,y:n+Math.sin(M)*(ie+re)/2,r:M+Math.PI/2,shape:t.shapes.BOX,width:k%3===0?.2:.1,height:.4,type:t.bodyTypes.FIXED_OBJECT,color:"#999",categoryBits:s,maskBits:0})}Ot=e.makeObject(f++,{x:o+Math.sin(Re)*(De/2-.2),y:n-Math.cos(Re)*(De/2-.2),r:Re,shape:t.shapes.BOX,width:.05,height:De,mass:.1,color:"#ff4444",categoryBits:h,maskBits:0});const Vt=e.createHingeJoint(f++,V,Ot,{worldAnchor:{x:o,y:n},anchorB:{x:0,y:De/2-.2}});e.createGearJoint(f++,Ke,Vt,-1);const Ze=o-1.5,Qe=n-1.5,Kt=e.makeObject(f++,{x:Ze,y:Qe,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#888",categoryBits:s,maskBits:0}),yt=e.makeObject(f++,{x:Ze,y:Qe,shape:t.shapes.CIRCLE,radius:1,mass:.2,r:0,color:"#4444ff",categoryBits:c,maskBits:0});yt.angularDamping=.01;const bt=e.createHingeJoint(f++,Kt,yt,{worldAnchor:{x:Ze,y:Qe}});e.createGearJoint(f++,Ke,bt,1/10);const ft=e.makeObject(f++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:.8,mass:.2,r:Me,color:"#4444ff",categoryBits:c,maskBits:0});ft.angularDamping=.01;const et=e.createHingeJoint(f++,V,ft,{worldAnchor:{x:o,y:n}});e.createGearJoint(f++,bt,et,1/6),Bt=e.makeObject(f++,{x:o+Math.sin(Me)*(Le/2-.3),y:n-Math.cos(Me)*(Le/2-.3),r:Me,shape:t.shapes.BOX,width:.12,height:Le,mass:.2,color:"#4444ff",categoryBits:h,maskBits:0});const Zt=e.createHingeJoint(f++,V,Bt,{worldAnchor:{x:o,y:n},anchorB:{x:0,y:Le/2-.3}});e.createGearJoint(f++,et,Zt,-1);const tt=o+2,nt=n-1,Qt=e.makeObject(f++,{x:tt,y:nt,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#888",categoryBits:s,maskBits:0}),xt=e.makeObject(f++,{x:tt,y:nt,shape:t.shapes.CIRCLE,radius:1,mass:.2,r:0,color:"#cccc44",categoryBits:c,maskBits:0});xt.angularDamping=.01;const wt=e.createHingeJoint(f++,Qt,xt,{worldAnchor:{x:tt,y:nt}});e.createGearJoint(f++,et,wt,1/3);const It=e.makeObject(f++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:1.1,mass:.2,r:je,color:"#cc8844",categoryBits:c,maskBits:0});It.angularDamping=.01;const vt=e.createHingeJoint(f++,V,It,{worldAnchor:{x:o,y:n}});e.createGearJoint(f++,wt,vt,1/4),Tt=e.makeObject(f++,{x:o+Math.sin(je)*(Se/2-.4),y:n-Math.cos(je)*(Se/2-.4),r:je,shape:t.shapes.BOX,width:.18,height:Se,mass:.3,color:"#cc8844",categoryBits:h,maskBits:0});const en=e.createHingeJoint(f++,V,Tt,{worldAnchor:{x:o,y:n},anchorB:{x:0,y:Se/2-.4}});e.createGearJoint(f++,vt,en,-1)},onTickRaw:`(world, dt) => {
        const s = world.scoreState;
        if (s) {
    ...
    }`,onTick:(e,o)=>{const n=e.scoreState;if(n){const r=performance.now(),c=5e3;let h=0,u=!1;if(n.fastGear){const g=n.fastGear.r-n.lastFastR;g<-.01&&(u=!0),h=Math.max(0,g)/(Math.PI*2),n.lastFastR=n.fastGear.r}if(n.history.push({time:r,rotDelta:h,isReversal:u}),n.pendulum){const g=Math.sign(n.pendulum.r);if(g!==n.lastPendSide&&g!==0){if(n.lastPendCrossing>0){const I=(r-n.lastPendCrossing)/500;I>.2&&I<5&&n.periodTimes.push({time:r,period:I})}n.lastPendCrossing=r,n.lastPendSide=g}}const p=r-c;for(;n.history.length>0&&n.history[0].time<p;)n.history.shift();for(;n.periodTimes.length>0&&n.periodTimes[0].time<p;)n.periodTimes.shift();let i=0,m=0;for(const g of n.history)i+=g.rotDelta,g.isReversal&&m++;const d=Math.abs(n.pendulum.r)+Math.abs(n.pendulum.rs)*.5,y=Math.abs(n.fastGear.rs);let l=i*5e3;if(l-=m*20,l+=d*200,l+=y*50,n.periodTimes.length>0){const g=n.periodTimes.reduce((v,O)=>v+O.period,0)/n.periodTimes.length,I=Math.abs(g-1);l+=Math.max(0,1e3*(1-I*2))}if(i<.005&&(l-=2e3),n.scoreDisplay.textContent=`Recent Score (5s): ${Math.floor(l)}`,n.isOptimizing){const g=["crankRadius","groundDist","rockerLength","springFreq","springX"];n.optimizationStage==="PREPARE"?(n.bestScore=l,n.optimizationStage="TWEAK",n.evalTimer=r+c,n.improvedThisCycle=!1):r>n.evalTimer&&n.optimizationStage==="TWEAK"&&(l>n.bestScore+.1?(n.bestScore=l,n.improvedThisCycle=!0,n.optStatus.textContent=`Optimizer: Improved ${g[n.optParamIndex]} (Score: ${Math.floor(l)})`,console.log(`Optimizer: Found improvement! New best score: ${Math.floor(l)}`)):(n.params[g[n.optParamIndex]]-=n.epsilon*n.optDirection,n.updateSimulation(),n.updateSliderUI(g[n.optParamIndex])),n.optDirection*=-1,n.optDirection===1&&(n.optParamIndex++,n.optParamIndex>=g.length&&(n.optParamIndex=0,n.improvedThisCycle||(n.epsilon*=.8,n.epsilon=Math.max(n.epsilon,.002),console.log(`Optimizer: No improvements this cycle. Shrinking epsilon to ${n.epsilon.toFixed(4)}`)),n.improvedThisCycle=!1)),n.params[g[n.optParamIndex]]+=n.epsilon*n.optDirection,n.updateSimulation(),n.updateSliderUI(g[n.optParamIndex]),n.evalTimer=r+c,n.optStatus.textContent=`Opt: Testing ${g[n.optParamIndex]} (${n.optDirection>0?"+":"-"}) eps=${n.epsilon.toFixed(4)}`)}else n.optStatus.textContent="Optimizer: Idle"}R&&Math.abs(R.r)<.1&&Math.abs(R.rs)>.02&&Math.abs(R.rs)<1.2&&R.applyAngularImpulse(Math.sign(R.rs)*.4);const s=new Date().toLocaleTimeString();if(t.debug.clearLabels(),t.debug.addLabel({text:"Mechanical Clockwork",x:5,y:.5,fontSize:"28px Arial",color:"#bbb",position:"on-top"}),t.debug.addLabel({text:s,x:5,y:9.5,fontSize:"36px Arial",color:"#fff",position:"on-top"}),R){const r=(R.r*180/Math.PI).toFixed(1);t.debug.addLabel({text:`Pendulum: ${r}°`,x:8,y:8,fontSize:"16px Arial",color:"#cd853f",position:"on-top"})}},onCleanup:e=>{const o=document.getElementById("clock-tuner-gui");o&&o.remove()}});let H=1,$=null;const yn=new w({name:"Gnome Omega Engine",key:"gnome-omega",description:["A detailed simulation of a **Gnome Omega** rotary engine. In this classic radial design, the crankshaft remains stationary while the entire cylinder block rotates around it.","### Features","- **Stationary Crankshaft**: A fixed pivot point (red) offset from the center.","- **Rotating Crankcase**: The main grey hub that carries the cylinders.","- **Weld Constraints**: Cylinders are 'welded' to the hub using a combination of `HingeJoint` and `DistanceJoint` for maximum stability.","- **Reciprocating Motion**: Pistons and connecting rods are synchronized via `HingeJoint` constraints.","- **Collision Masks**: Bitwise filtering ensures pistons only interact with their respective cylinder walls.","Click **Reset** if the simulation becomes unstable due to extreme angular velocities."].join(`
...
`),onInitRaw:`(world) => {
    ...
    }`,onInit:e=>{e.clear(),t.debug.showAabbs=!1,H=1,$=null;const o=5,n=4.5,a=.8,s=7,r=2.5,c=256,h=512,u=1024,p=2048,i=4096,m=e.makeObject(H++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:.15,type:t.bodyTypes.FIXED_OBJECT,color:"#888",categoryBits:c,maskBits:0}),d=e.makeObject(H++,{x:o,y:n+a,shape:t.shapes.CIRCLE,radius:.1,type:t.bodyTypes.FIXED_OBJECT,color:"#ff4444",categoryBits:c,maskBits:0});$=e.makeObject(H++,{x:o,y:n,shape:t.shapes.CIRCLE,radius:.8,mass:50,color:"#aaa",categoryBits:h,maskBits:0,restitution:0}),e.createHingeJoint(H++,m,$,{worldAnchor:{x:o,y:n}});for(let y=0;y<s;y++){const l=y/s*Math.PI*2,g=Math.cos(l),I=Math.sin(l),v=l-Math.PI/2,O=2.6,A=.28,T=2.5,F=1,j=S=>{const Ae=o+g*O+-I*(S*F/2),we=n+I*O+g*(S*F/2),K=e.makeObject(H++,{x:Ae,y:we,r:v,shape:t.shapes.BOX,width:A,height:T,mass:1,color:"#bbb",categoryBits:u,maskBits:p,restitution:0,sFriction:0,kFriction:0}),qe=K.localToWorld({x:0,y:-T/2}),ae=K.localToWorld({x:0,y:T/2});e.createHingeJoint(H++,$,K,{worldAnchor:qe}),e.createDistanceJoint(H++,$,K,{worldAnchor:ae})};j(-1),j(1);const X=a*Math.sin(l)+Math.sqrt(r*r-Math.pow(a*Math.cos(l),2)),N=o+g*X,L=n+I*X,fe=e.makeObject(H++,{x:N,y:L,r:v,shape:t.shapes.BOX,width:.7,height:1,mass:.5,color:"#ddd",categoryBits:p,maskBits:u,restitution:0,sFriction:0,kFriction:0}),We=(o+N)/2,xe=(n+a+L)/2,V=Math.atan2(L-(n+a),N-o)-Math.PI/2,me=e.makeObject(H++,{x:We,y:xe,r:V,shape:t.shapes.BOX,width:.15,height:r,mass:.2,color:"#fff",categoryBits:i,maskBits:0,restitution:0});e.createHingeJoint(H++,me,d,{anchorA:{x:0,y:-r/2},anchorB:{x:0,y:0}}),e.createHingeJoint(H++,me,fe,{anchorA:{x:0,y:r/2},anchorB:{x:0,y:0}})}e.setGravity(0,0),$.rs=2},onTickRaw:`(world, dt) => {
        if (engineHub) {
...
`),onInitRaw:`(world) => {
    ...
    }`,onInit:e=>{e.clear(),Ct(),t.debug.showAabbs=!1,e.setGravity(0,9.8),e.setHasRestitution(!0),e.setHasFriction(!0);const o=5,n=6,a=4,s=5,r=.2;e.makeObject(Ce++,{x:o,y:n+s/2+r/2,shape:t.shapes.BOX,width:a+r*2,height:r,type:t.bodyTypes.FIXED_OBJECT,color:"#664422"}),e.makeObject(Ce++,{x:o-a/2-r/2,y:n,shape:t.shapes.BOX,width:r,height:s,type:t.bodyTypes.FIXED_OBJECT,color:"#664422"}),e.makeObject(Ce++,{x:o+a/2+r/2,y:n,shape:t.shapes.BOX,width:r,height:s,type:t.bodyTypes.FIXED_OBJECT,color:"#664422"});const c=(p,i,m,d=!1)=>{if(m>=ue.length)return null;const y=ue[m],l=Ce++,g=e.makeObject(l,{x:p,y:i,shape:t.shapes.CIRCLE,radius:y.radius,mass:y.mass,color:y.color,restitution:.2,staticFriction:.5,kineticFriction:.3});return g&&(g.wantsEvents=!0,x.fruitIds.set(l,m),d&&(g.vx=(Math.random()-.5)*.1)),g};e.onCollisionStart=(p,i)=>{if(x.isGameOver)return;const m=x.fruitIds.get(p),d=x.fruitIds.get(i);if(m!==void 0&&d!==void 0&&m===d){if(x.mergingIds.has(p)||x.mergingIds.has(i))return;const y=m;if(y>=ue.length-1)return;x.mergingIds.add(p),x.mergingIds.add(i);const l=e.getObjectById(p),g=e.getObjectById(i);if(l&&g){const I=(l.x+g.x)/2,v=(l.y+g.y)/2;setTimeout(()=>{e.removeObject(p),e.removeObject(i),x.fruitIds.delete(p),x.fruitIds.delete(i),x.mergingIds.delete(p),x.mergingIds.delete(i),c(I,v,y+1)&&(x.score+=ue[y+1].score)},0)}}},W=document.getElementById("debug-canvas"),e._onMouseMove&&W.removeEventListener("mousemove",e._onMouseMove),e._onClick&&W.removeEventListener("click",e._onClick);const h=p=>{if(x.isGameOver)return;const i=W.getBoundingClientRect();x.mouseX=bn(p.clientX-i.left);const m=ue[x.nextFruitLevel].radius;x.mouseX=Math.max(o-a/2+m,Math.min(o+a/2-m,x.mouseX))},u=p=>{if(x.isGameOver){e.clear(),Ct(),Jt.onInit(e);return}const i=Date.now();i-x.lastDropTime>x.dropCooldown&&(c(x.mouseX,n-s/2-1,x.nextFruitLevel,!0),x.nextFruitLevel=Math.floor(Math.random()*5),x.lastDropTime=i)};e._onMouseMove=h,e._onClick=u,W.addEventListener("mousemove",h),W.addEventListener("click",u)},onTickRaw:`(world, dt) => {
        gb2d.debug.clearLabels();
...
`),onInitRaw:`(world) => {
    ...
    }`,onInit:e=>{e.clear(),t.debug.showAabbs=!1,C=1,de=[],Q={};const o=5,n=5;e.setGravity(0,9.81),e.setHasRestitution(!0),e.setHasFriction(!0),D=e.makeObject(C++,{x:o,y:n,shape:t.shapes.BOX,width:1.2,height:.4,mass:10,color:"#ff4444",categoryBits:be,maskBits:ee}),D.angularDamping=.5,ye=e.makeObject(C++,{x:o,y:n-.15,shape:t.shapes.CIRCLE,radius:.25,mass:5,color:"#444",categoryBits:0,maskBits:0});const a=e.createHingeJoint(C++,D,ye,{worldAnchor:{x:o,y:n-.15}}),s=e.makeObject(C++,{x:o-.6,y:n+.2,shape:t.shapes.BOX,width:.6,height:.1,mass:1,color:"#666",categoryBits:be,maskBits:ee});e.createHingeJoint(C++,D,s,{anchorA:{x:-.4,y:.1},anchorB:{x:.3,y:0}}),e.createSpringJoint(C++,D,s,{anchorA:{x:-.6,y:-.2},anchorB:{x:-.2,y:0},frequencyHz:20,dampingRatio:.5}),Je=e.makeObject(C++,{x:o-.9,y:n+.2,shape:t.shapes.CIRCLE,radius:.4,mass:2,color:"#333",categoryBits:Be,maskBits:ee}),Je.kineticFriction=2.5,Je.staticFriction=3;const r=e.createHingeJoint(C++,s,Je,{anchorA:{x:-.3,y:0},anchorB:{x:0,y:0}});e.createGearJoint(C++,a,r,-2);const c=e.makeObject(C++,{x:o+.7,y:n+.2,shape:t.shapes.BOX,width:.1,height:.8,r:.3,mass:1,color:"#666",categoryBits:be,maskBits:ee});e.createHingeJoint(C++,D,c,{anchorA:{x:.5,y:0},anchorB:{x:0,y:-.3}}),e.createSpringJoint(C++,D,c,{anchorA:{x:.2,y:.2},anchorB:{x:0,y:.1},frequencyHz:15,dampingRatio:.7}),Fe=e.makeObject(C++,{x:o+.8,y:n+.5,shape:t.shapes.CIRCLE,radius:.4,mass:2,color:"#333",categoryBits:Be,maskBits:ee}),Fe.kineticFriction=2,Fe.staticFriction=2.5,e.createHingeJoint(C++,c,Fe,{anchorA:{x:0,y:.4},anchorB:{x:0,y:0}});const h=e.makeObject(C++,{x:o,y:n+2,shape:t.shapes.BOX,width:20,height:1,type:t.bodyTypes.FIXED_OBJECT,color:"#444",categoryBits:ee,maskBits:be|Be});de.push(h),e.makeObject(C++,{x:-7.72,y:.01,r:1.2,shape:t.shapes.BOX,width:15,height:1,type:t.bodyTypes.FIXED_OBJECT,color:"#333",categoryBits:ee,maskBits:be|Be});const u=l=>Q[l.code]=!0,p=l=>Q[l.code]=!1;te=document.getElementById("debug-canvas");const i=l=>fn(l,e),m=l=>xn(l),d=l=>wn(l,e),y=e._motorcycleListeners;y&&(window.removeEventListener("keydown",y.onKeyDown),window.removeEventListener("keyup",y.onKeyUp),te&&te.removeEventListener("mousedown",y.mouseDownHandler),window.removeEventListener("mousemove",y.mouseMoveHandler),window.removeEventListener("mouseup",y.mouseUpHandler)),window.addEventListener("keydown",u),window.addEventListener("keyup",p),te.addEventListener("mousedown",i),window.addEventListener("mousemove",m),window.addEventListener("mouseup",d),e._motorcycleListeners={onKeyDown:u,onKeyUp:p,mouseDownHandler:i,mouseMoveHandler:m,mouseUpHandler:d}},onTickRaw:`(world, dt) => {
        if (!chassis) return;
    ...
    }`,onTick:(e,o)=>{if(!D)return;const n=150,a=100,s=100;if(Q.KeyD&&ye.rs<s&&ye.applyAngularImpulse(n*o),Q.KeyA&&ye.rs>-s&&ye.applyAngularImpulse(-n*o),Q.KeyW&&D.applyAngularImpulse(-a*o),Q.KeyS&&D.applyAngularImpulse(a*o),Q.KeyR){Pt.init(e);return}const r=D.x,c=D.y,h=t.debug.canvas?.width||800,u=t.debug.canvas?.height||600,p=(l,g,I)=>l+(g-l)*I,i=t.debug.zoom,m=h/2-r*100*i,d=u/2-c*100*i;t.debug.offsetX=p(t.debug.offsetX,m,.1),t.debug.offsetY=p(t.debug.offsetY,d,.1);const y=de[de.length-1];if(y.x<D.x+25){const l=6+Math.random()*8,g=1.2,I=(Math.random()-.5)*.5,v=Math.random()<.2?1.5:0,O=y.localToWorld({x:y.width/2,y:0}),A=O.x+v;let T=O.y+(v>0?(Math.random()-.5)*3:0);T=Math.max(2,Math.min(8,T));const F=Math.cos(I),j=Math.sin(I),X=A+l/2*F,N=T+l/2*j,L=e.makeObject(C++,{x:X,y:N,r:I,shape:t.shapes.BOX,width:l,height:g,type:t.bodyTypes.FIXED_OBJECT,color:`hsl(${20+Math.random()*40}, 30%, ${30+Math.random()*20}%)`,categoryBits:ee,maskBits:be|Be});if(de.push(L),de.length>50){const fe=de.shift();e.removeObject(fe.id)}}t.debug.clearLabels(),D.x<15&&(t.debug.addLabel({text:"Motorcycle Trials",x:5,y:3,fontSize:"28px Arial",color:"#fff",position:"on-top"}),t.debug.addLabel({text:"Use D/A to drive and W/S to balance!",x:5,y:3.5,fontSize:"16px Arial",color:"#aaa",position:"on-top"}))},onCleanup:e=>{const o=e._motorcycleListeners;o&&(window.removeEventListener("keydown",o.onKeyDown),window.removeEventListener("keyup",o.onKeyUp),te&&te.removeEventListener("mousedown",o.mouseDownHandler),window.removeEventListener("mousemove",o.mouseMoveHandler),window.removeEventListener("mouseup",o.mouseUpHandler),delete e._motorcycleListeners),pe&&(e.removeJoint(pe.id),pe=null),J&&(e.removeObject(J.id),J=null),t.debug.offsetX=0,t.debug.offsetY=0}}),In=[Jt,un,yn,Pt],he=[{name:"Showcase",examples:In},{name:"General",examples:ln},{name:"Constraints",examples:hn},{name:"Optimizations",examples:pn},{name:"Load Tests",examples:mn},{name:"Known Issues",examples:gn}];let vn=`
...
`.trim();const Ee=()=>window.innerWidth<=768;let ne={},U=null;function kn(){const e=document.getElementById("examples-list");e.innerHTML="",he.forEach((o,n)=>{const a=document.createElement("li");a.className="section",a.textContent=o.name,e.appendChild(a),o.examples&&Array.isArray(o.examples)&&o.examples.forEach((s,r)=>{const c=s.key||`${n}-${r}`;ne[c]={category:n,index:r,example:s};const h=document.createElement("li");h.className="example",h.textContent=s.name,h.setAttribute("data-example",c),e.appendChild(h)})}),document.querySelectorAll("#sidebar li.example").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll("#sidebar li.example.selected").forEach(a=>{a.classList.remove("selected")}),o.classList.add("selected");const n=o.getAttribute("data-example");ht(n,"push"),Ee()&&se.classList.add("collapsed")})})}let _,Et=0,zt=document.getElementById("example-name"),q=document.getElementById("debug-canvas"),at=document.getElementById("code-section"),On=document.getElementById("general-code"),Bn=document.getElementById("init-code"),Tn=document.getElementById("tick-code"),le=document.getElementById("toggle-code"),Cn=document.getElementById("fps"),En=document.getElementById("memory"),An=document.getElementById("step-time"),At=document.querySelectorAll(".code-tab"),Rn=document.querySelectorAll(".code-panel"),Yt=document.getElementById("sidebar-toggle"),se=document.getElementById("sidebar"),Mn=document.getElementById("reset-button"),jn=document.getElementById("reset-button-mobile"),Rt=document.getElementById("info-toggle"),Mt=document.getElementById("info-toggle-mobile");zt.innerHTML="Loading example...";let P=0,it=[],rt=[],ct=[],Ge=1e3/60,jt=0,Dt=0;t.init().then(()=>{_=t.makeWorld(),t.debug.enableDebugGraphics(q,_);function e(){const i=performance.now(),m=i-Et,d=Math.max(0,17-m);setTimeout(()=>{const y=performance.now();if(_.step(),U&&ne[U]){const T=ne[U].example;T&&typeof T.onTick=="function"&&T.onTick(_,m/1e3)}const g=(performance.now()-y)*1e3;let I=it[P%100]??Ge,v=rt[P%100]??0,O=ct[P%100]??0;it[P%100]=m||16.67,rt[P%100]=performance.memory.usedJSHeapSize/1048576,ct[P%100]=g,Ge+=(it[P%100]-I)/100,jt+=(rt[P%100]-v)/100,Dt+=(ct[P%100]-O)/100,P++;const A=Ge>0?Math.round(1e3/Ge):0;Cn.innerHTML=`<i class="fas fa-tachometer-alt"></i>FPS: ${A}`,En.innerHTML=`<i class="fas fa-memory"></i>Memory: ${jt.toFixed(2)} MB`,An.innerHTML=`<i class="fas fa-stopwatch"></i>Step Time: ${Dt.toFixed(0)} μs`,Et=i,requestAnimationFrame(e)},d)}kn(),$t(!0);const o=()=>{U&&ht(U,"none")};Mn.addEventListener("click",o),jn.addEventListener("click",o);const n=()=>{document.body.classList.toggle("info-mode");const i=document.body.classList.contains("info-mode"),m=i?"fa-th-large":"fa-info-circle",d=i?"Show Canvas":"Info";[Rt,Mt].forEach(y=>{const l=y.querySelector("i"),g=y.querySelector(".button-text");l&&(l.className=`fas ${m}`),g&&(g.textContent=d),y.title=i?"Show Canvas":"Show Information"}),i||t.debug.centerCamera(5,5)};Rt.addEventListener("click",n),Mt.addEventListener("click",n),e(),Ee()&&se.classList.add("collapsed"),q.addEventListener("wheel",i=>{i.preventDefault();const m=.05,d=i.offsetX,y=i.offsetY,l=(d-t.debug.offsetX)/t.debug.zoom,g=(y-t.debug.offsetY)/t.debug.zoom,I=-Math.sign(i.deltaY),v=Math.pow(1+m,I),O=Math.min(Math.max(t.debug.zoom*v,.1),10);t.debug.zoom=O,t.debug.offsetX=d-l*t.debug.zoom,t.debug.offsetY=y-g*t.debug.zoom},{passive:!1});let a=!1,s=0,r=0;q.addEventListener("mousedown",i=>{i.button===2&&(a=!0,s=i.clientX,r=i.clientY)}),window.addEventListener("mousemove",i=>{if(a){const m=i.clientX-s,d=i.clientY-r;t.debug.offsetX+=m,t.debug.offsetY+=d,s=i.clientX,r=i.clientY}}),window.addEventListener("mouseup",i=>{i.button===2&&(a=!1)}),q.addEventListener("contextmenu",i=>{i.preventDefault()});let c=0,h=!1,u=0,p=0;q.addEventListener("touchstart",i=>{if(i.touches.length===1)u=i.touches[0].clientX,p=i.touches[0].clientY,h=!1;else if(i.touches.length===2){h=!0;const m=i.touches[0].clientX-i.touches[1].clientX,d=i.touches[0].clientY-i.touches[1].clientY;c=Math.sqrt(m*m+d*d)}},{passive:!1}),q.addEventListener("touchmove",i=>{if(i.touches.length!==0){if(i.preventDefault(),i.touches.length===1&&!h){const m=i.touches[0].clientX,d=i.touches[0].clientY,y=m-u,l=d-p;t.debug.offsetX+=y,t.debug.offsetY+=l,u=m,p=d}else if(i.touches.length===2){const m=i.touches[0],d=i.touches[1],y=m.clientX-d.clientX,l=m.clientY-d.clientY,g=Math.sqrt(y*y+l*l);if(c>0){const I=g/c,v=Math.min(Math.max(t.debug.zoom*I,.1),10),O=(m.clientX+d.clientX)/2,A=(m.clientY+d.clientY)/2,T=q.getBoundingClientRect(),F=O-T.left,j=A-T.top,X=(F-t.debug.offsetX)/t.debug.zoom,N=(j-t.debug.offsetY)/t.debug.zoom;t.debug.zoom=v,t.debug.offsetX=F-X*t.debug.zoom,t.debug.offsetY=j-N*t.debug.zoom}c=g}}},{passive:!1}),q.addEventListener("touchend",i=>{i.touches.length<2&&(h=!1,c=0),i.touches.length===1&&(u=i.touches[0].clientX,p=i.touches[0].clientY)},{passive:!1}),q.addEventListener("touchcancel",i=>{h=!1,c=0},{passive:!1})});function ht(e,o="push"){if(!_||!ne[e])return;if(U&&ne[U]){const p=ne[U].example;p&&typeof p.cleanup=="function"&&p.cleanup(_)}const n="#"+e;window.location.hash!==n&&(o==="push"?history.pushState(null,"",n):o==="replace"&&history.replaceState(null,"",n)),_.clear(),t.debug.clearLabels(),t.debug.showForceVectors=!1,t.debug.showImpulseVectors=!1,_.setHasPenetrationResolution(!0),_.setHasRestitution(!0),_.setHasFriction(!0),_.setGravity(0,0),t.debug.zoom=1,t.debug.centerCamera(5,5),t.debug.showAabbs=!0,U=e;const s=ne[e].example;s&&typeof s.onInit=="function"?s.onInit(_):console.error("Example onInit method not found:",s);function r(p,i){if(!p)return`function ${i}${i==="tick"?"(dt)":"()"} {}`;let m=p.split("	").join("    ");const d=[/^\(world\)\s*=>\s*\{/,/^\(world,\s*dt\)\s*=>\s*\{/,/^function\s*\(world\)\s*\{/,/^function\s*\(world,\s*dt\)\s*\{/,/^function\s+init\s*\(world\)\s*\{/,/^function\s+tick\s*\(world,\s*dt\)\s*\{/];let y=!1,l=m.trim();for(const v of d)if(v.test(l)){m=l.replace(v,`function ${i}${i==="tick"?"(dt)":"()"} {`),y=!0;break}y||(m=l.replace(/^.*?=>\s*\{/,`function ${i}${i==="tick"?"(dt)":"()"} {`));let g=m.split(`
`);if(g.length<=1)return m;let I=1/0;for(let v=1;v<g.length;v++){const O=g[v];if(O.trim().length===0)continue;const A=O.search(/\S/);A!==-1&&A<I&&(I=A)}return I===1/0&&(I=0),g.map((v,O)=>O===0?v:v.substring(Math.min(v.length,I))).join(`
`)}let c=s.globalLines?.join(`
`)??"",h=s.onInitRaw||s.onInit?.toString()||"",u=s.onTickRaw||s.onTick?.toString()||"";On.textContent=vn.split("{{GLOBAL}}").join(c),Bn.textContent=r(h,"init"),Tn.textContent=r(u,"tick"),Wt(),zt.textContent=s.name||"Unknown Example",document.getElementById("description").innerHTML=nn.parse(s.description||"")}function $t(e=!1){let o=window.location.hash.substring(1);const n=!o;if(o||(o="sandbox"),!ne[o]){console.log("Example not found directly, searching...");let s=!1;for(let r=0;r<he.length;r++){const c=he[r];if(c.examples&&Array.isArray(c.examples)){for(let h=0;h<c.examples.length;h++)if(c.examples[h].key===o){console.log(`Found example ${o} in category ${r}, index ${h}`),s=!0;break}}if(s)break}if(!s)if(console.warn(`Example with key '${o}' not found, defaulting to first available example`),he.length>0&&he[0].examples&&he[0].examples.length>0)o=he[0].examples[0].key||"0-0";else{console.error("No examples found");return}}const a=document.querySelector(`#sidebar li.example[data-example="${o}"]`);a&&(document.querySelectorAll("#sidebar li.example.selected").forEach(s=>{s.classList.remove("selected")}),a.classList.add("selected")),ht(o,n&&e?"replace":"none")}At.forEach(e=>{e.addEventListener("click",()=>{At.forEach(n=>n.classList.remove("active")),Rn.forEach(n=>n.classList.remove("active")),e.classList.add("active"),document.getElementById(`${e.dataset.panel}-panel`).classList.add("active")})});function Wt(){document.querySelectorAll("pre").forEach(o=>{const n=o.textContent;o.innerHTML=hljs?.highlight(n,{language:"javascript"}).value})}le.addEventListener("click",()=>{at.style.display==="none"?(at.style.display="block",le.querySelector("span").textContent="Hide Code",le.querySelector("i").classList.remove("fa-chevron-down"),le.querySelector("i").classList.add("fa-chevron-up"),Wt()):(at.style.display="none",le.querySelector("span").textContent="Show Code",le.querySelector("i").classList.remove("fa-chevron-up"),le.querySelector("i").classList.add("fa-chevron-down"))});Yt.addEventListener("click",()=>{se.classList.toggle("collapsed")});window.addEventListener("resize",()=>{Ee()||document.body.classList.remove("info-mode"),Ee()&&!se.classList.contains("collapsed")&&se.classList.add("collapsed")});window.addEventListener("click",e=>{Ee()&&!se.classList.contains("collapsed")&&!se.contains(e.target)&&e.target!==Yt&&se.classList.add("collapsed")});const Te=document.getElementById("copy-code");Te.addEventListener("click",()=>{const o=document.querySelector(".code-panel.active").querySelector("pre").textContent;navigator.clipboard.writeText(o).then(()=>{const n=Te.querySelector("span"),a=Te.querySelector("i"),s=n.textContent;Te.classList.add("success"),n.textContent="Copied!",a.classList.remove("fa-copy"),a.classList.add("fa-check"),setTimeout(()=>{Te.classList.remove("success"),n.textContent=s,a.classList.remove("fa-check"),a.classList.add("fa-copy")},2e3)})});window.addEventListener("popstate",function(e){$t(!1)});
