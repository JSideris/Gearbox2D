...
const TYPE_OFFSET = 2;
const HAS_AABB_COLLISION_OFFSET = 3;
...
class PhysicalObject{
	...
	get hasAabbCollision() { return this.liveIData[this.index * SIZE_I + HAS_AABB_COLLISION_OFFSET]; }
		...
		this.debugWorld.iterateObjects((obj)=>{
			...
			{ // Draw the AABB.
				if(this.debugWorld.objectCount < 500){
					...
					let x1 = obj.ax2;
					let y1 = obj.ay2;
					// console.log(obj.hasAabbCollision);
					...
					if(obj.hasAabbCollision) this.ctx.fill();
					this.ctx.stroke();
				}
			}
