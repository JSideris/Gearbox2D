...
const G_SCALE_OFFSET = 7 // How much gravity affects this object.
const RESTITUTION_OFFSET = 8 // Bounciness
const S_FRICTION_OFFSET = 9 // Static friction
const K_FRICTION_OFFSET = 10 // Kinetic friction
const DAMPING_OFFSET = 11 // Linear damping (air resistance)
const ANGULAR_DAMPING_OFFSET = 12 // Angular damping

const RADIUS_OFFSET = 13;
const WIDTH_OFFSET = 13;
...
class PhysicalObject{
    ...
    set shape(v) { return this.liveIData[this.index * SIZE_I + SHAPE_OFFSET] = v; }

    get x() { return this.liveFData[this.index * SIZE_F + X_OFFSET]; }
    set x(v) { return this.liveFData[this.index * SIZE_F + X_OFFSET] = v; }
    
    get y() { return this.liveFData[this.index * SIZE_F + Y_OFFSET]; }
    set y(v) { return this.liveFData[this.index * SIZE_F + Y_OFFSET] = v; }
    
    get r() { return this.liveFData[this.index * SIZE_F + R_OFFSET]; }
    set r(v) { return this.liveFData[this.index * SIZE_F + R_OFFSET] = v; }
    
    get vx() { return this.liveFData[this.index * SIZE_F + VX_OFFSET]; }
    set vx(v) { return this.liveFData[this.index * SIZE_F + VX_OFFSET] = v; }
    
    get vy() { return this.liveFData[this.index * SIZE_F + VY_OFFSET]; }
    set vy(v) { return this.liveFData[this.index * SIZE_F + VY_OFFSET] = v; }
    
    get rs() { return this.liveFData[this.index * SIZE_F + RS_OFFSET]; }
    set rs(v) { return this.liveFData[this.index * SIZE_F + RS_OFFSET] = v; }
    
    get mass() { return this.liveFData[this.index * SIZE_F + MASS_OFFSET]; }
    set mass(v) { return this.liveFData[this.index * SIZE_F + MASS_OFFSET] = v; }
    
    get fx() { return this.liveFData[this.index * SIZE_F + FX_OFFSET]; }
    // set fx(v) { return this.liveFData[this.index * SIZE_F + FX_OFFSET] = v; }
    
    get fy() { return this.liveFData[this.index * SIZE_F + FY_OFFSET]; }
    // set fy(v) { return this.liveFData[this.index * SIZE_F + FY_OFFSET] = v; }
    
    get ix() { return this.liveFData[this.index * SIZE_F + IX_OFFSET]; }
    // set ix(v) { return this.liveFData[this.index * SIZE_F + IX_OFFSET] = v; }
    
    get iy() { return this.liveFData[this.index * SIZE_F + IY_OFFSET]; }
    // set iy(v) { return this.liveFData[this.index * SIZE_F + IY_OFFSET] = v; }
    
    get radius() { return this.liveFData[this.index * SIZE_F + RADIUS_OFFSET]; }
    set radius(v) { return this.liveFData[this.index * SIZE_F + RADIUS_OFFSET] = v; }
    
    get width() { return this.liveFData[this.index * SIZE_F + WIDTH_OFFSET]; } // width shares a common index with radius
    set width(v) { return this.liveFData[this.index * SIZE_F + WIDTH_OFFSET] = v; }
    
    get height() { return this.liveFData[this.index * SIZE_F + HEIGHT_OFFSET]; }
    set height(v) { return this.liveFData[this.index * SIZE_F + HEIGHT_OFFSET] = v; }
    
    get ax1() { return this.liveFData[this.index * SIZE_F + AX1_OFFSET]; }
    // set ax1(v) { return this.liveFData[this.index * SIZE_F + AX1_OFFSET] = v; }
    
    get ay1() { return this.liveFData[this.index * SIZE_F + AY1_OFFSET]; }
    // set ay1(v) { return this.liveFData[this.index * SIZE_F + AY1_OFFSET] = v; }
    
    get ax2() { return this.liveFData[this.index * SIZE_F + AX2_OFFSET]; }
    // set ax2(v) { return this.liveFData[this.index * SIZE_F + AX2_OFFSET] = v; }
    
    get ay2() { return this.liveFData[this.index * SIZE_F + AY2_OFFSET]; }
    // set ay2(v) { return this.liveFData[this.index * SIZE_F + AY2_OFFSET] = v; }
	...
	set gScale(v) { return this.liveFData[this.index * SIZE_F + G_SCALE_OFFSET] = v; }

	get restitution() { return this.liveFData[this.index * SIZE_F + RESTITUTION_OFFSET]; }
	set restitution(v) { return this.liveFData[this.index * SIZE_F + RESTITUTION_OFFSET] = v; }
	
	get staticFriction() { return this.liveFData[this.index * SIZE_F + S_FRICTION_OFFSET]; }
	set staticFriction(v) { return this.liveFData[this.index * SIZE_F + S_FRICTION_OFFSET] = v; }
	
	// get dynamicFriction() { return this.liveFData[this.index * SIZE_F + D_FRICTION_OFFSET]; }
	// set dynamicFriction(v) { return this.liveFData[this.index * SIZE_F + D_FRICTION_OFFSET] = v; }
	
	get kineticFriction() { return this.liveFData[this.index * SIZE_F + F_FRICTION_OFFSET]; }
	set kineticFriction(v) { return this.liveFData[this.index * SIZE_F + F_FRICTION_OFFSET] = v; }
	...
	_animate(){
		...
		this.debugWorld.iterateObjects((obj)=>{
			...
			{ // Impulse vector.
				...
				this.ctx.beginPath();
				this.ctx.moveTo(obj.x * ANIMSCALE, obj.y * ANIMSCALE);
				this.ctx.lineTo(obj.x * ANIMSCALE + obj.ix * 3.0, obj.y * ANIMSCALE + obj.iy * 3.0);
				this.ctx.stroke();
				...
				if(impulseScale > 100){
					...
					let arrowX = obj.x * ANIMSCALE + obj.ix * 3;
					let arrowY = obj.y * ANIMSCALE + obj.iy * 3;
					this.ctx.save();
					this.ctx.translate(arrowX, arrowY);
					this.ctx.rotate(angle);
					this.ctx.beginPath();
